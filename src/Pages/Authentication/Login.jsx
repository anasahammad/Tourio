...
const Login = () => {
    ...
    const { signInWithGoogle, signIn, loading, setLoading, signInWithTwitter, resetPassword } =
      useAuth()
      const {
        register,
        handleSubmit,
    ...
    return (
        <div className="w-full my-6 max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <form onSubmit={handleSubmit(handleForm)}  className="mt-6">
                ...
                <div className="mt-4">
                    <div className="flex items-center justify-between">
                        ...
                        <button onClick={handleResetPassword} className="text-xs text-gray-600 dark:text-gray-400 hover:underline">Forget Password?</button>
                    </div>
            ...
            <div className="flex items-center mt-6 -mx-2">
                ...
                <button onClick={handleTwitterSignIn} className="p-2 mx-2 text-sm font-medium text-gray-500 transition-colors duration-300 transform bg-gray-300 rounded-lg hover:bg-gray-200">
