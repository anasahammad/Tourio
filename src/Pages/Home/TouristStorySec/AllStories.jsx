    ...
    return (
        <div>
             <div className="bg-[#EFEEDB] py-6 px-4 text-center">
                <h1 className="text-2xl font-bold font-dm-sans  md:text-4xl">All Stories</h1>
                             ...
                             <div className=" cursor-pointer rounded-md shadow-md ">
                                <div className="flex items-center justify-between p-3">
                                    <div className="flex items-center space-x-2">
                                        <img src={story?.authorImage} alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm dark:bg-gray-500 dark:border-gray-300" />
                                        <div className="-space-y-1">
                                            <h2 className="text-sm font-semibold leading-none">{story?.author}</h2>
                                            <span className="inline-block text-xs leading-none dark:text-gray-600">{story?.date}</span>
                                        </div>
                                    </div>
                                ...
                                <img src={story?.storyImages[0]} alt="" className="object-cover object-center w-full h-72 dark:bg-gray-500" />
                                <div className="p-3">
