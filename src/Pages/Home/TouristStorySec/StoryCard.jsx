...
const StoryCard = ({story}) => {
    return (
        <div >
			...
			<div className="flex flex-col cursor-pointer  space-y-6 overflow-hidden rounded-xl shadow-lg bg-white ">
	<div className="flex px-4 space-x-4">
		<img alt="" src={story?.authorImage} className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
		<div className="flex flex-col  space-y-1">
			<a rel="noopener noreferrer" href="#" className="text-sm font-semibold">{story?.author}</a>
			<span className="text-xs dark:text-gray-600">{new Date(story?.date).toLocaleDateString()}</span>
		</div>
	</div>
	<div>
