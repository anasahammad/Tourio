        ...
        <div className="min-h-screen ">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Welcome to Tourio Community</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                        <h2 className="text-2xl font-bold mb-2 text-[#017b6e]">Latest Posts</h2>
                        <p className="text-gray-700">Check out the latest posts from our community members.</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                        <h2 className="text-2xl font-bold mb-2 text-[#017b6e]">Top Contributors</h2>
                        <p className="text-gray-700">See who are the most active contributors in our community.</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                        <h2 className="text-2xl font-bold mb-2 text-[#017b6e]">Join a Discussion</h2>
                        <p className="text-gray-700">Participate in ongoing discussions and start your own.</p>
                    </div>
                </div>

                <div className="mt-12 bg-white p-6 rounded-lg shadow-lg">
                    <h2 className="text-2xl font-bold mb-4 text-[#017b6e]">Community Highlights</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="mt-12 text-center">
                    ...
                    <button className="mt-6 bg-[#017b6e] text-white py-2 px-6 rounded-full text-lg hover:bg-[#e05b65] transition-colors">
                        Sign Up Now
                    </button>
                </div>
            </div>
